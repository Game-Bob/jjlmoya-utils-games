...
const UTILITY_ASSET_ROOT = "/_utilities/games";
...
export const getUtilityOgImage = (englishSlug: string): string =>
    withAssetVersion(`/_utilities/games/images/${englishSlug}.webp`);

export const getUtilityCssPath = (englishSlug: string): string =>
    withAssetVersion(`/_utilities/games/styles/${englishSlug}.css`);

export const CATEGORY_OG_IMAGE = getUtilityOgImage("games");
