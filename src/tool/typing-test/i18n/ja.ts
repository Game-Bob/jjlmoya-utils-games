...
export const content: GamesToolLocaleContentType = {
  ...
  seo: [
    ...
    { type: 'paragraph', html: '<strong>毎日の練習:</strong> 短時間でも毎日続けると、指の動きが安定します。数週間に一度の長時間練習より、集中した10分を積み重ねる方が効果的です。' },
    { type: 'title', text: '入力ミスを減らす方法', level: 2 },
    { type: 'paragraph', html: '速度を上げる前に、間違えやすいキーの組み合わせを確認しましょう。正確な入力を優先すると、結果的に実際のWPMも伸びていきます。' },
    { type: 'paragraph', html: '手首を机に強く押し付けず、肩の力を抜いてください。痛みや疲れを感じたら休憩し、無理に記録を更新しないことが大切です。' },
    { type: 'paragraph', html: '同じ文章だけで練習せず、通常の文章、数字、句読点を組み合わせると、実際の作業に近い入力能力を身につけられます。' },
  ],
  faq: faqItems,
  howTo: howToItems,
  bibliography,
