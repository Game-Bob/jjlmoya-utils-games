...
export const content: GamesToolLocaleContentType = {
  ...
  seo: [
    ...
    { type: 'paragraph', html: '<strong>Regelmäßiges Training:</strong> Kurze, tägliche Einheiten bauen sichere Bewegungsmuster auf. Zehn konzentrierte Minuten sind nachhaltiger als eine lange Sitzung alle paar Wochen.' },
    { type: 'title', text: 'Ergonomie und Schreibkomfort', level: 2 },
    { type: 'paragraph', html: 'Halte Schultern und Handgelenke entspannt, stelle den Bildschirm auf Augenhöhe und unterbrich die Übung bei Schmerzen. Geschwindigkeit darf niemals auf Kosten einer gesunden Haltung gehen.' },
  ],
  faq: faqItems,
  howTo: howToItems,
  bibliography,
