...
export const content: TypingTestLocaleContentType = {
  ...
  seo: [
    ...
    { type: 'title', text: '每天练习的方法', level: 2 },
    { type: 'paragraph', html: '短时间、规律的练习可以稳定手指动作。每天专注十分钟，比隔几周进行一次长时间练习更有效。' },
    { type: 'paragraph', html: '先保证准确率，再逐步提高速度。稳定且少出错的输入能力，比偶然得到的最高分更有价值。' },
    { type: 'title', text: '舒适的打字姿势', level: 2 },
    { type: 'paragraph', html: '放松肩膀，让手腕保持自然姿势，并把屏幕放在视线高度。如果出现疼痛，应立即停止练习。' },
    { type: 'paragraph', html: '不要用力敲击按键。轻触可以减少疲劳，也有助于保持均匀的节奏。' },
    { type: 'title', text: '练习真实工作场景', level: 2 },
    { type: 'paragraph', html: '如果工作中需要输入数字、标点或代码，也应把它们加入练习。只练习简单单词无法代表真实的输入任务。' },
    { type: 'paragraph', html: '单独练习经常出错的单词和按键组合。针对性重复比单纯延长测试时间更有效。' },
    { type: 'paragraph', html: '请在相同的时长和难度下比较结果，这样WPM和准确率的变化才真正说明了进步。' },
    { type: 'title', text: '如何理解测试结果', level: 2 },
    { type: 'paragraph', html: '一次很好的成绩不能完整代表你的能力。应观察多次测试的平均值，以及在错误不增加时能否保持速度。' },
    { type: 'paragraph', html: '疲劳、噪声和压力可能暂时降低成绩。记录测试时的状态，有助于正确解读数据。' },
    { type: 'paragraph', html: '更换语言或键盘布局后，手指需要重新适应。短暂的速度下降是正常现象。' },
    { type: 'title', text: '休息与健康', level: 2 },
    { type: 'paragraph', html: '每隔20到30分钟让眼睛离开屏幕，并活动手指。正确的姿势和规律休息可以降低长时间输入的负担。' },
    { type: 'paragraph', html: '不要忽视持续的不适。结束练习，必要时向专业人士寻求建议。' },
    { type: 'paragraph', html: '开始下一轮测试前先分析错误。这样的反馈可以让后续练习更有针对性。' },
  ],
  faq: faqItems,
  howTo: howToItems,
  bibliography,
