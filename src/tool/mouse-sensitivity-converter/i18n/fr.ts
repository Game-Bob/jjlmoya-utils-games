...
const description = 'Convertissez votre sensibilité de souris entre jeux vidéo en conservant votre distance physique pour un tour complet de 360 degrés.';

const faqItems = [
  { question: 'Convertisseur de Sensibilité Souris Entre Jeux', answer: 'Convertissez votre sensibilité de souris entre jeux vidéo en conservant votre distance physique pour un tour complet de 360 degrés.' },
